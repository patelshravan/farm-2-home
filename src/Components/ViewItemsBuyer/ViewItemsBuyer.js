...
const ViewItemsBuyer = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Button onClick={goToCart} buttonStyle="btn--primary--outline">
      ...
      <div>
        ...
        >
          <form>
            ...
            <Button buttonStyle="btn--primary--outline">Buy Now</Button>{" "}
            <Button buttonStyle="btn--primary--outline">Add To Cart</Button>
          </form>
          <br />
        </Card>
      </div>
